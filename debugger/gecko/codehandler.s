...
# This is a modified version of the code handler from Gecko OS.
# It does not wait for an ACK after sending bytes for "read memory" command.
# This is much faster, but probably unreliable on real hardware.
# It also reports version 0x42.
...
_setvalues:
    ...
    stw r21, 0x643C(r24)		# allow setting EXI clock to 32MHz
