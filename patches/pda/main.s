...
.mainLoop_doneBackpack:
    ...
    # tell other patches the menu is open.
    LOADW   r5,  PATCH_STATE_PTR
    stb     r4,  PDA_MENU_OPEN(r5)
...
.prevPage:
    li      r4,  0
.getPage:
    slwi    r3,  r17, 2 # r3 = r17 * 4
    addi    r3,  r3,  (menuPageStructure - mainLoop)
    add     r3,  r3,  r4
    lbzx    r3,  r3,  r14 # get prev/next page number for this page

.setPage:
    li      r4,  0xFC # sound effect ID
.setPageWithSound:
    stb     r3,  (menuPage - mainLoop)(r14)
    li      r3,  MOVE_DELAY
    stb     r3,  (menuJustMoved - mainLoop)(r14)
    # reset cursor to first item
    li      r3,  0
    stb     r3,  (menuSelItem - mainLoop)(r14)
    b       .doSound
...
.close: # close the menu
    slwi    r3,  r17, 2 # r3 = r17 * 4
    addi    r3,  r3,  (menuPageStructure - mainLoop) + 2
    lbzx    r3,  r3,  r14 # get parent page number for this page
    cmpwi   r3,  0xFF
    bne     .close_toParent

    # no parent; exit the menu entirely
    li      r3,  0
