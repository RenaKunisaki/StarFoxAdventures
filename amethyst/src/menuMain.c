...
Menu menuMain = {
    ...
    "Game Settings",    "%s", genericMenuItem_draw, menuMainGameSettings_select,
    "Control Settings", "%s", genericMenuItem_draw, menuMainControlSettings_select,
    "Player Settings",  "%s", genericMenuItem_draw, menuMainPlayerSettings_select,
    "Video Settings",   "%s", genericMenuItem_draw, menuMainVideoSettings_select,
    "Audio Settings",   "%s", genericMenuItem_draw, menuMainAudioSettings_select,
    "PDA Settings",     "%s", genericMenuItem_draw, menuMainPdaSettings_select,
    "Debug",            "%s", genericMenuItem_draw, menuMainDebug_select,
    NULL,
};
